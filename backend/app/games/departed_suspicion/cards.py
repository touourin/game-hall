...
EQUIPMENT_CARDS: tuple[EquipmentDefinition, ...] = (
    _card(1, "blackmail", "勒索信", "Blackmail", "base", "own_turn", "交换两名其他存活玩家各一张底细；牌的公开状态不变。"),
    _card(2, "coffee", "咖啡", "Coffee", "base", "other_turn", "当前玩家结束回合后，你立刻获得一个完整回合；之后从原回合玩家在当前方向上的下一家继续。"),
    ...
    _card(19, "fingerprint_kit", "指纹工具", "Fingerprint Kit", "bombers", "anytime", "调查任意玩家一张暗置底细；若再公开自己一张暗牌，本牌回到手中。"),
    ...
    _card(26, "inspection_gloves", "搜查手套", "Inspection Gloves", "undercover", "anytime", "目标在可执行选项中选择：弃掉手中装备、弃掉卧底牌，或向所有人展示全部暗牌后重新暗置。"),
    _card(27, "key", "钥匙", "Key", "undercover", "anytime", "放在另一名玩家面前；其每回合可在正常行动前或后额外调查一次，仍受遮蔽与伪装限制。", persistent=True),
    _card(28, "med_kit", "医疗包", "Med Kit", "undercover", "anytime", "移除探员或头目领袖牌上的受伤标记。"),
    _card(29, "mobile_detonator", "移动引爆器", "Mobile Detonator", "undercover", "post_shot", "自己中枪且尚未产生胜者时，可使另一名玩家也中枪；只能使用中枪前已持有的本牌。"),
    _card(30, "new_assignment", "新任务", "New Assignment", "undercover", "anytime", "交换两名玩家的卧底牌，原遮蔽位置不变。", requires_cover=True),
    _card(31, "security_wand", "安检棒", "Security Wand", "undercover", "anytime", "调查另一名玩家一张暗置底细；随后可将自己一张公开底细重新暗置。若因此重新形成掩护，按卧底规则移动卧底牌。"),
    _card(32, "sunglasses", "太阳镜", "Sunglasses", "undercover", "anytime", "把任意两张公开底细重新暗置，可同属一名玩家；受影响且没有卧底牌的玩家各获得一张卧底牌。"),
    _card(33, "thumbprint_scanner", "指纹扫描器", "Thumbprint Scanner", "undercover", "shot_before_reveal", "任意玩家中枪后、公开全部底细和结算伤害前，先私看其全部底细，再可用自己任意底细交换其一张普通正直/腐败底细。"),
)
