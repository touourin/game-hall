...
- 内置游戏与第三方插件游戏共用个人账号、登录会话和四套全局界面皮肤：极光雾舱、曜石黑钛、月白陶瓷和橙釉象牙；界面皮肤与棋盘、扑克皮肤相互独立
...
新增或重写大厅自带游戏前，必须阅读[官方游戏开发与主题适配规范](frontend/src/games/README.md)。新游戏只维护一套结构和玩法逻辑，通过主题令牌或 Canvas 调色板适配极光雾舱、曜石黑钛、月白陶瓷与橙釉象牙；图标、电脑端、手机端和四主题对比度也属于完成条件。
