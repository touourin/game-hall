...
.artwork-skin-gallery article[data-artwork-treatment="codex-ink-wash"]::after { position: absolute; z-index: 2; inset: 64% 0 0; background: linear-gradient(180deg, transparent 0%, rgba(7,18,27,.9) 12%, #07121b 22%, #02090a 100%); content: ''; pointer-events: none; }
.artwork-skin-gallery article[data-artwork-treatment="codex-ink-wash"] > div { z-index: 3; min-height: 30%; padding-top: 34px; background: transparent; }
