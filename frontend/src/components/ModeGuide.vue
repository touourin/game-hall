...
.mode-guide-quick-start { border: 1px solid color-mix(in srgb, var(--gold) 46%, var(--line)); border-radius: 15px; padding: 14px; background: color-mix(in srgb, var(--gold) 9%, var(--surface)); box-shadow: inset 0 0 0 1px color-mix(in srgb, var(--gold) 7%, transparent); }
.mode-guide-quick-start > div { margin-bottom: 12px; }
.mode-guide-quick-start small, .mode-guide-complete-rules > header small, .mode-guide-background small { color: var(--gold); font-size: 9px; font-weight: 850; letter-spacing: .12em; }
...
.mode-guide-quick-start li > span { display: grid; place-items: center; width: 25px; height: 25px; border-radius: 8px; color: var(--accent-contrast); background: var(--gold); font-size: 10px; font-weight: 900; }
...
.mode-guide-flow h4 { margin: 0 0 11px; color: var(--gold); font-size: 12px; }
...
.mode-guide-flow li > span { display: grid; place-items: center; width: 25px; height: 25px; border: 1px solid color-mix(in srgb, var(--gold) 35%, var(--line)); border-radius: 8px; color: var(--gold); background: color-mix(in srgb, var(--gold) 8%, transparent); font-size: 10px; font-weight: 900; }
...
.mode-guide-table-wrap th { color: var(--text); background: color-mix(in srgb, var(--gold) 8%, var(--surface-inset)); white-space: nowrap; }
.mode-guide-background { border: 1px solid color-mix(in srgb, var(--gold) 30%, var(--line)); border-radius: 15px; padding: 15px; background: radial-gradient(circle at 90% 0%, color-mix(in srgb, var(--gold) 11%, transparent), transparent 34%), rgba(var(--surface-deep-rgb), .62); }
