...
.role-skin-loadout-heading > span { display: grid; flex: 0 0 auto; place-items: center; width: 42px; height: 42px; border: 1px solid color-mix(in srgb, var(--gold) 28%, var(--line)); border-radius: 14px; color: var(--gold); background: color-mix(in srgb, var(--gold) 8%, var(--surface-inset)); }
...
.role-skin-role-copy em { color: var(--gold); font-size: 8px; font-style: normal; }
...
.role-skin-picker-modal { display: grid; grid-template-rows: auto minmax(0, 1fr); width: min(980px, calc(100vw - 32px)); max-height: min(90dvh, 760px); min-height: 0; overflow: hidden; border: 1px solid color-mix(in srgb, var(--gold) 30%, var(--line)); border-radius: 24px; color: var(--text); background: var(--modal-surface); box-shadow: var(--shadow); }
