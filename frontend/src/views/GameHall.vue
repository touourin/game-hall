      ...
      <section class="nexus-command-grid">
        <article class="nexus-feature surface">
          ...
          <div class="nexus-arena" aria-hidden="true">
            ...
            <span class="nexus-arena-core"><Swords :size="31" :stroke-width="1.25" /><small>{{ featuredRoom ? `${featuredRoom.playerCount}/${featuredRoom.maxPlayers}` : featuredCatalogGame.players.replace(' 人', 'P') }}</small></span>
...
.nexus-arena { position:absolute; width:min(85%,330px); aspect-ratio:1; top:47%; left:50%; transform:translate(-50%,-50%); }.nexus-ring { position:absolute; border:1px solid color-mix(in srgb,var(--gold) 32%,transparent); border-radius:50%; }.nexus-ring-outer { inset:4%; box-shadow:0 0 42px color-mix(in srgb,var(--gold) 8%,transparent); }.nexus-ring-outer::before,.nexus-ring-outer::after { position:absolute; inset:9%; border:1px solid color-mix(in srgb,var(--gold) 13%,transparent); border-radius:50%; content:''; }.nexus-ring-outer::after { inset:22%; border-color:color-mix(in srgb,var(--accent-secondary) 38%,transparent); border-style:dashed; }.nexus-ring-inner { inset:34%; border-color:var(--gold); box-shadow:var(--glow-primary); }.nexus-arena-core { position:absolute; inset:39%; display:grid; place-items:center; align-content:center; gap:5px; border:1px solid var(--gold); border-radius:50%; color:var(--gold); background:var(--surface-inset); box-shadow:0 0 28px color-mix(in srgb,var(--gold) 18%,transparent); }.nexus-arena-core small { font-family:ui-monospace,"SFMono-Regular",Consolas,monospace; font-size:6px; }.nexus-ping { position:absolute; width:9px; height:9px; border:2px solid var(--accent-secondary); border-radius:50%; background:var(--surface-elevated); box-shadow:0 0 11px var(--accent-secondary); }.ping-one { left:22%; top:18%; }.ping-two { right:15%; top:35%; }.ping-three { right:27%; bottom:13%; }.ping-four { left:12%; bottom:31%; }
