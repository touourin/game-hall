...
.tone-red { --card-tone: #e88a82; }.tone-chess { --card-tone: #c8b596; }.tone-jade { --card-tone: #72d0ad; }.tone-blue { --card-tone: #86bde4; }.tone-ink { --card-tone: #d7d8d1; }
...
:global(:root[data-theme="royal"] .tone-red) { --card-tone: #a54e40; }:global(:root[data-theme="royal"] .tone-chess) { --card-tone: #78664e; }:global(:root[data-theme="royal"] .tone-jade) { --card-tone: #36785f; }:global(:root[data-theme="royal"] .tone-blue) { --card-tone: #3f6f91; }:global(:root[data-theme="royal"] .tone-ink) { --card-tone: #4d4a43; }:global(:root[data-theme="royal"] .tone-army) { --card-tone: #85651f; }:global(:root[data-theme="royal"] .tone-pulse) { --card-tone: #39785e; }:global(:root[data-theme="royal"] .tone-focus) { --card-tone: #346f68; }:global(:root[data-theme="royal"] .tone-mine) { --card-tone: #a44a42; }:global(:root[data-theme="royal"] .tone-tower) { --card-tone: #90602d; }:global(:root[data-theme="royal"] .tone-poker) { --card-tone: #a54e40; }:global(:root[data-theme="royal"] .tone-fortune) { --card-tone: #9b6d25; }:global(:root[data-theme="royal"] .tone-suspicion) { --card-tone: #82542d; }
