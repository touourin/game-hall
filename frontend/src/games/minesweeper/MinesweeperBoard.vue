...
.minesweeper-status-data { min-width: 0; display: flex; gap: 7px; }.minesweeper-status-data > span { min-width: 82px; min-height: 39px; display: grid; grid-template-columns: auto auto; align-content: center; justify-content: center; column-gap: 5px; border: 1px solid var(--line); border-radius: 11px; padding: 4px 9px; background: var(--surface-inset); }.minesweeper-status-data svg { color: var(--gold); }.minesweeper-status-data b { font-size: 14px; }.minesweeper-status-data small { grid-column: 1 / 3; color: var(--muted); font-size: 8px; text-align: center; }
...
.minesweeper-mode { display: flex; border: 1px solid var(--line); border-radius: 10px; overflow: hidden; }.minesweeper-mode button { min-height: 38px; display: inline-flex; align-items: center; gap: 5px; border: 0; padding: 0 11px; color: var(--muted); background: var(--surface-inset); font-weight: 850; }.minesweeper-mode button + button { border-left: 1px solid var(--line); }.minesweeper-mode button.active { color: var(--accent-contrast); background: var(--gold); }
.minesweeper-zoom { display: flex; align-items: center; border: 1px solid var(--line); border-radius: 10px; overflow: hidden; }.minesweeper-zoom button { width: 36px; min-height: 36px; display: grid; place-items: center; border: 0; color: var(--muted); background: var(--surface-inset); }.minesweeper-zoom span { min-width: 48px; color: var(--gold); font-size: 10px; font-weight: 900; text-align: center; }
.minefield-viewport { min-width: 0; max-width: 100%; max-height: min(68vh, 720px); overflow: auto; border: 1px solid var(--line); border-radius: 14px; padding: 12px; background: color-mix(in srgb, var(--surface-inset) 82%, var(--bg)); box-shadow: inset 0 12px 30px color-mix(in srgb, var(--panel-shadow) 38%, transparent); overscroll-behavior: contain; scrollbar-color: color-mix(in srgb, var(--gold) 38%, transparent) transparent; }
...
.mine-cell.state-flagged { color: var(--gold); background: linear-gradient(145deg, color-mix(in srgb, var(--gold) 12%, var(--surface-strong)), var(--surface-strong)); }.mine-cell.state-mine { color: var(--red); background: color-mix(in srgb, var(--red) 14%, var(--surface-inset)); }.mine-cell.state-exploded { z-index: 2; color: white; border-color: color-mix(in srgb, var(--red) 76%, white); background: var(--red); box-shadow: 0 0 0 4px color-mix(in srgb, var(--red) 18%, transparent), 0 0 24px color-mix(in srgb, var(--red) 40%, transparent); animation: mine-burst .38s ease; }.mine-cell.state-wrong_flag { color: var(--red); background: color-mix(in srgb, var(--red) 12%, var(--surface-inset)); }.wrong-flag { display: flex; align-items: center; font-weight: 950; }
@keyframes mine-burst { 45% { transform: scale(1.18) rotate(6deg); } }
.minesweeper-progress { height: 5px; overflow: hidden; border-radius: 999px; background: var(--surface-inset); }.minesweeper-progress i { display: block; height: 100%; border-radius: inherit; background: linear-gradient(90deg, var(--gold), var(--green)); transition: width .18s ease; }
