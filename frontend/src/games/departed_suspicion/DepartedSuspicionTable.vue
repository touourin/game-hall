...
<template>
  <section class="suspicion-table">
    ...
    <section v-if="freshKnowledge.length" class="private-result-notice surface" aria-live="polite">
      ...
      <UiIconButton compact aria-label="关闭新底细提示" @click="freshKnowledgeKeys = []"><X :size="17" /></UiIconButton>
    </section>
...
.private-result-notice { display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: center; gap: 11px; padding: 13px 15px; border-color: color-mix(in srgb, var(--case-blue) 42%, var(--line)); background: linear-gradient(120deg, color-mix(in srgb, var(--case-blue) 8%, var(--surface)), var(--surface)); }.private-result-notice > svg { color: var(--case-blue); }.private-result-notice > div { min-width: 0; display: flex; align-items: center; flex-wrap: wrap; gap: 4px 8px; }.private-result-notice strong,.private-result-notice small { width: 100%; }.private-result-notice small { color: var(--muted); }.private-result-notice span { border-radius: 999px; padding: 4px 7px; color: var(--case-blue); background: color-mix(in srgb, var(--case-blue) 10%, var(--surface-inset)); font-size: 8px; font-weight: 800; }
...
.decision-panel,.turn-console,.equipment-hand,.history-panel { padding: 15px; }.decision-panel { display: grid; gap: 12px; border-color: color-mix(in srgb, var(--case-gold) 30%, var(--line)); }.urgent-panel { border-color: color-mix(in srgb, var(--case-red) 40%, var(--line)); background: linear-gradient(120deg, color-mix(in srgb, var(--case-red) 6%, var(--surface)), var(--surface)); }.decision-panel > div:first-child { display: flex; align-items: center; gap: 10px; }.decision-panel > div:first-child > div { display: grid; }.decision-panel small,.decision-panel p { color: var(--muted); }.panel-icon { width: 38px; aspect-ratio: 1; display: grid; place-items: center; border-radius: 11px; color: var(--case-gold); background: color-mix(in srgb, var(--case-gold) 12%, var(--surface-inset)); }.urgent-panel .panel-icon { color: var(--case-red); background: color-mix(in srgb, var(--case-red) 14%, var(--surface-inset)); }
