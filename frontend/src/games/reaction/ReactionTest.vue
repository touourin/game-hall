...
.reaction-status > span { width: 42px; aspect-ratio: 1; display: grid; place-items: center; border-radius: 12px; color: var(--green); background: color-mix(in srgb, var(--green) 10%, transparent); }
.reaction-status small, .reaction-status strong { display: block; }.reaction-status small { color: var(--accent); font-size: 9px; font-weight: 850; letter-spacing: .15em; }.reaction-status strong { margin-top: 3px; }
.round-dots { display: flex; gap: 7px; }.round-dots i { width: 9px; aspect-ratio: 1; border: 1px solid var(--line); border-radius: 50%; background: var(--bg); }.round-dots i.current { border-color: var(--accent); box-shadow: 0 0 0 4px color-mix(in srgb, var(--accent) 9%, transparent); }.round-dots i.complete { border-color: var(--green); background: var(--green); }
...
.reaction-panel.stage-ready { border-color: color-mix(in srgb, var(--green) 48%, var(--line)); background: radial-gradient(circle at 50% 55%, color-mix(in srgb, var(--green) 14%, transparent), transparent 46%), var(--surface); transition: none; }
.reaction-panel.stage-false-start { border-color: color-mix(in srgb, var(--red) 42%, var(--line)); background: radial-gradient(circle at 50% 55%, color-mix(in srgb, var(--red) 9%, transparent), transparent 46%), var(--surface); }
.reaction-copy { min-height: 58px; display: flex; align-items: center; justify-content: center; gap: 11px; }.reaction-copy-icon { width: 46px; aspect-ratio: 1; display: grid; place-items: center; border-radius: 14px; color: var(--green); background: color-mix(in srgb, var(--green) 9%, transparent); }.reaction-copy-icon.warning { color: var(--red); background: color-mix(in srgb, var(--red) 9%, transparent); }.reaction-copy strong, .reaction-copy small { display: block; text-align: left; }.reaction-copy strong { font-family: "Songti SC", "STSong", serif; font-size: 22px; }.reaction-copy small { margin-top: 4px; color: var(--muted); }
.reaction-trigger { position: relative; width: min(72vw, 300px); aspect-ratio: 1; display: grid; place-items: center; align-content: center; gap: 10px; border: 1px solid color-mix(in srgb, var(--accent) 32%, transparent); border-radius: 48px; color: var(--accent); background: linear-gradient(145deg, color-mix(in srgb, var(--accent) 11%, transparent), color-mix(in srgb, var(--bg) 34%, transparent)), var(--surface-strong); box-shadow: inset 0 1px 0 color-mix(in srgb, var(--panel-highlight) 38%, transparent), var(--shadow-raised); cursor: pointer; overflow: hidden; transition: transform .14s; touch-action: manipulation; user-select: none; }
...
.reaction-trigger:focus-visible { outline: 2px solid var(--accent); outline-offset: 4px; }
...
.reaction-trigger.ready { border-color: color-mix(in srgb, var(--green) 72%, var(--line)); color: var(--accent-contrast); box-shadow: 0 0 0 10px color-mix(in srgb, var(--green) 8%, transparent), 0 24px 70px color-mix(in srgb, var(--green) 26%, transparent); }
.reaction-trigger.ready::before { background: var(--green); }
.reaction-trigger.false-start { color: color-mix(in srgb, var(--red) 72%, var(--text)); border-color: color-mix(in srgb, var(--red) 42%, var(--line)); background: color-mix(in srgb, var(--red) 16%, var(--surface-inset)); }.reaction-trigger.saving, .reaction-trigger.result, .reaction-trigger.finished { opacity: 1; }
.keyboard-hint { margin: 0; color: var(--muted); font-size: 11px; }.keyboard-hint kbd { margin-right: 3px; border: 1px solid var(--line); border-bottom-width: 3px; border-radius: 7px; padding: 4px 7px; color: var(--text); background: var(--surface-inset); font: inherit; font-weight: 850; }
.reaction-metrics { display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; }.reaction-metrics > div { padding: 14px; text-align: center; }.reaction-metrics small, .reaction-metrics strong { display: block; }.reaction-metrics small { color: var(--muted); }.reaction-metrics strong { margin-top: 5px; color: var(--accent); font-size: 17px; }
.reaction-result { padding: 24px; display: grid; justify-items: center; gap: 8px; text-align: center; }.reaction-result > span { color: var(--green); font-weight: 850; }.reaction-result > strong { color: var(--text); font-family: "Songti SC", "STSong", serif; font-size: clamp(46px, 12vw, 68px); line-height: 1; }.reaction-result > strong small { color: var(--accent); font-family: inherit; font-size: 20px; }.reaction-result > p { margin: 0 0 8px; color: var(--muted); }.reaction-result > div { width: min(100%, 430px); display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; }.reaction-result > div span { padding: 10px 7px; border: 1px solid var(--line); border-radius: 11px; color: var(--muted); font-size: 10px; }.reaction-result > div b { display: block; margin-top: 3px; color: var(--text); font-size: 13px; }.reaction-result .ui-button--primary { margin-top: 12px; }
@keyframes waiting-pulse { 50% { border-color: color-mix(in srgb, var(--accent) 22%, transparent); box-shadow: inset 0 1px 0 color-mix(in srgb, var(--panel-highlight) 32%, transparent), 0 18px 45px color-mix(in srgb, var(--panel-shadow) 35%, transparent); } }
