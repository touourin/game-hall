...
.reaction-trigger { appearance: none; width: min(72vw, 300px); aspect-ratio: 1; display: grid; place-items: center; align-content: center; gap: 10px; border: 1px solid #e1bc6850; border-radius: 48px; color: var(--gold); background: linear-gradient(145deg, #e1bc681b, #06171955), var(--surface-strong); box-shadow: inset 0 1px 0 #ffffff14, 0 24px 55px #0007; cursor: pointer; transition: transform .14s; touch-action: manipulation; user-select: none; -webkit-appearance: none; }
