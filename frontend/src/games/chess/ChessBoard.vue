...
.chess-status { min-height: 28px; display: flex; flex-wrap: wrap; justify-content: center; align-items: center; gap: 7px 14px; color: var(--muted); text-align: center; }.chess-status strong { color: var(--gold); }.chess-status .selection { color: color-mix(in srgb, var(--gold) 78%, var(--text)); font-weight: 800; }.chess-status .check { border-radius: 999px; padding: 4px 8px; color: var(--accent-contrast); background: var(--red); font-weight: 900; }
...
.promotion-backdrop,.replay-backdrop { position: fixed; z-index: 80; inset: 0; display: grid; place-items: center; padding: 18px; background: var(--backdrop); backdrop-filter: blur(7px); }.promotion-panel { width: min(92vw, 430px); display: grid; gap: 16px; border: 1px solid color-mix(in srgb, var(--gold) 40%, var(--line)); border-radius: 18px; padding: 18px; background: var(--surface-strong); box-shadow: var(--shadow); }.promotion-panel header,.replay-panel header { display: flex; justify-content: space-between; align-items: center; }.promotion-panel header > div,.replay-panel header > div { display: grid; }.promotion-panel header small,.replay-panel header small { color: var(--gold); }.promotion-panel > div { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 8px; }.promotion-panel > div button { min-width: 0; min-height: 96px; display: grid; place-items: center; gap: 3px; border: 1px solid var(--line); border-radius: 12px; color: var(--text); background: var(--surface-inset); }.promotion-panel > div span { font-family: "Times New Roman", serif; font-size: 48px; line-height: 1; }.promotion-panel > div span.white { color: #fff8df; text-shadow: 0 1px #4a3d31, 1px 0 #4a3d31, 0 -1px #4a3d31, -1px 0 #4a3d31; }.promotion-panel > div span.black { color: #222; text-shadow: 0 1px #ddd; }
.replay-panel { width: min(92vw, 560px); max-height: min(82vh, 720px); display: grid; grid-template-rows: auto 1fr auto; gap: 12px; border: 1px solid var(--line); border-radius: 17px; padding: 17px; background: var(--surface-strong); box-shadow: var(--shadow); }.move-list { min-height: 0; overflow: auto; display: grid; grid-template-columns: 1fr 1fr; gap: 7px; }.move-list button { min-height: 42px; display: grid; grid-template-columns: auto 1fr auto; align-items: center; gap: 7px; border: 1px solid var(--line); border-radius: 8px; padding: 7px 9px; color: var(--text); background: var(--surface-inset); text-align: left; }.move-list button.active { border-color: var(--gold); background: color-mix(in srgb, var(--gold) 12%, var(--surface-inset)); }.move-list span { color: var(--muted); }.move-list b { font-family: ui-monospace, monospace; }.move-list em { color: var(--red); font-style: normal; font-size: 10px; }.replay-panel footer { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }.replay-panel footer button { min-height: 42px; display: flex; justify-content: center; align-items: center; gap: 5px; border: 1px solid var(--line); border-radius: 9px; color: var(--text); background: var(--surface-inset); }
