...
.promotion-backdrop,.replay-backdrop { position: fixed; z-index: 80; inset: 0; display: grid; place-items: center; padding: 18px; background: #020b0bd4; backdrop-filter: blur(7px); }.promotion-panel { width: min(92vw, 430px); display: grid; gap: 16px; border: 1px solid color-mix(in srgb, var(--gold) 40%, var(--line)); border-radius: 18px; padding: 18px; background: var(--surface-strong); box-shadow: 0 24px 70px #000a; }.promotion-panel header,.replay-panel header { display: flex; justify-content: space-between; align-items: center; }.promotion-panel header > div,.replay-panel header > div { display: grid; }.promotion-panel header small,.replay-panel header small { color: var(--gold); }.promotion-panel > div { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 8px; }.promotion-panel > div button { min-width: 0; min-height: 96px; display: grid; place-items: center; gap: 3px; border: 1px solid var(--line); border-radius: 12px; color: var(--text); background: var(--surface-inset); }.promotion-panel > div span { font-family: "Times New Roman", serif; font-size: 48px; line-height: 1; }.promotion-panel > div span.white { color: #fff8df; text-shadow: 0 1px #4a3d31, 1px 0 #4a3d31, 0 -1px #4a3d31, -1px 0 #4a3d31; }.promotion-panel > div span.black { color: #222; text-shadow: 0 1px #ddd; }
