...
@media (max-width: 360px) { .captured-pieces { grid-template-columns: 1fr; }.xiangqi-piece { inset: 5%; font-size: clamp(13px, 5.2vw, 18px); }.xiangqi-actions { grid-template-columns: 1fr 1fr; }.xiangqi-actions .arcade-danger-button { grid-column: 1 / -1; } }
</style>
