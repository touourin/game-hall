...
.schulte-status-metrics { min-width: 0; display: flex; gap: 7px; }.schulte-status-metrics > span { min-width: 0; min-height: 34px; display: inline-flex; align-items: center; gap: 5px; border: 1px solid var(--line); border-radius: 10px; padding: 0 9px; color: var(--text); background: var(--surface-inset); font-weight: 850; }.schulte-status-metrics svg { flex: 0 0 auto; color: var(--gold); }.schulte-status-metrics small { color: var(--muted); }
...
.schulte-intro-icon { width: 66px; aspect-ratio: 1; display: grid; place-items: center; border: 1px solid color-mix(in srgb, var(--green) 38%, var(--line)); border-radius: 20px; color: var(--green); background: color-mix(in srgb, var(--green) 8%, transparent); }.schulte-intro > small { color: var(--gold); font-weight: 850; letter-spacing: .08em; }.schulte-intro h2 { margin: 2px 0 0; font-family: "Songti SC", "STSong", serif; font-size: clamp(30px, 7vw, 46px); }.schulte-intro p { max-width: 460px; margin: 0; color: var(--muted); line-height: 1.7; }
...
.schulte-progress { height: 5px; overflow: hidden; border-radius: 999px; background: var(--surface-inset); }.schulte-progress i { display: block; height: 100%; border-radius: inherit; background: linear-gradient(90deg, var(--gold), var(--green)); transition: width .16s ease; }
