...
.poker-felt { position: relative; min-height: 610px; overflow: hidden; display: grid; grid-template-rows: 1fr auto auto; gap: 22px; border: 8px solid #5d351d; border-radius: 42% / 9%; padding: clamp(24px, 5vw, 48px); background: radial-gradient(ellipse at center, #176348 0%, #0d4b38 62%, #08382d 100%); box-shadow: inset 0 0 0 3px #bc8650, inset 0 0 70px #001b14aa, 0 20px 52px #0007; }.poker-felt::after { content: ''; pointer-events: none; position: absolute; inset: 14px; border: 1px solid #d7bd7855; border-radius: inherit; }
.opponent-grid { position: relative; z-index: 1; display: grid; grid-template-columns: repeat(auto-fit, minmax(118px, 1fr)); align-content: start; gap: 10px; }.poker-seat { border: 1px solid #ffffff20; border-radius: 14px; color: #effaf4; background: #062e27d9; box-shadow: 0 9px 20px #001b18aa; }.poker-seat.acting { border-color: #f2c862; box-shadow: 0 0 0 2px #f2c86244, 0 10px 24px #001c17; }.poker-seat.folded { opacity: .52; filter: grayscale(.45); }.opponent-seat { min-height: 112px; padding: 10px; display: grid; grid-template-rows: auto 1fr auto; gap: 6px; }.poker-seat header { display: flex; flex-wrap: wrap; align-items: center; gap: 4px; }.poker-seat header strong { min-width: 0; max-width: 100%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.poker-seat header span { border-radius: 5px; padding: 2px 4px; color: #241b0e; background: #e4bc67; font-size: 10px; font-weight: 900; }.opponent-seat footer { display: flex; flex-wrap: wrap; gap: 4px 7px; color: #aec8bd; font-size: 11px; }.opponent-seat footer b { color: #edca7e; }.opponent-seat footer em { width: 100%; color: #f4d58d; font-style: normal; font-weight: 800; }
.mini-hand { display: flex; align-items: center; justify-content: center; }.playing-card { width: clamp(42px, 9vw, 64px); aspect-ratio: 5 / 7; display: grid; align-content: space-between; border: 1px solid #d8d4c6; border-radius: 7px; padding: 5px; color: #17211f; background: linear-gradient(145deg, #fffdf6, #ddd9cc); box-shadow: 0 5px 10px #001d17aa; font-family: Georgia, serif; font-style: normal; }.playing-card b { line-height: 1; font-size: clamp(16px, 3.8vw, 24px); }.playing-card i { justify-self: end; line-height: 1; font-size: clamp(18px, 4vw, 26px); font-style: normal; }.playing-card.red { color: #bd2f35; }.playing-card.mini { width: 32px; border-radius: 5px; padding: 3px; }.playing-card.mini + .playing-card.mini { margin-left: -7px; }.playing-card.mini b { font-size: 12px; }.playing-card.mini i { font-size: 13px; }.card-back { place-items: center; border-color: #d0b06a; color: #e8c978; background: repeating-linear-gradient(45deg, #243d55 0 4px, #172c42 4px 8px); font-size: 14px; }.playing-card.empty { border-style: dashed; border-color: #e6d39230; background: #001e182e; box-shadow: none; }
