...
.poker-controls { padding: 14px; display: grid; gap: 10px; }.poker-controls p { margin: 0; color: var(--muted); text-align: center; }.primary-actions { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 7px; }.primary-actions button, .raise-button, .quick-raises button { min-height: 44px; border: 1px solid var(--line); border-radius: 10px; color: var(--text); background: var(--surface-inset); font-weight: 850; }.primary-actions .fold { color: var(--red); }.primary-actions .all-in { color: var(--gold); border-color: color-mix(in srgb, var(--gold) 35%, var(--line)); background: color-mix(in srgb, var(--gold) 8%, var(--surface-inset)); }.raise-controls { display: grid; grid-template-columns: 1fr auto auto; align-items: end; gap: 8px; }.quick-raises { display: flex; gap: 5px; }.quick-raises button { min-height: 38px; padding: 0 9px; color: var(--muted); font-size: 12px; }.raise-controls label { display: grid; gap: 3px; color: var(--muted); font-size: 11px; }.raise-controls input { width: 100px; min-height: 38px; border: 1px solid var(--line); border-radius: 9px; padding: 0 9px; color: var(--text); background: var(--surface-inset); }.raise-button { padding: 0 13px; color: var(--accent-contrast); background: var(--gold); }
