...
.one-night-heading > span { width: 44px; aspect-ratio: 1; display: grid; place-items: center; border: 1px solid color-mix(in srgb,var(--one-night-accent) 40%,var(--line)); border-radius: 14px; color: var(--one-night-accent); background: color-mix(in srgb,var(--one-night-accent) 10%,var(--surface-inset)); }
.one-night-heading small { color: var(--one-night-accent); font-size: 9px; font-weight: 900; letter-spacing: .16em; }.one-night-heading h2 { margin: 2px 0 3px; font-family: "Songti SC",serif; font-size: clamp(22px,4vw,30px); }.one-night-heading p { margin: 0; color: var(--muted); line-height: 1.55; }
.one-night-secret { max-width: 320px; margin: 0; color: var(--text-soft); font-size: 12px; line-height: 1.65; text-align: center; }.one-night-wait,.moon-waiting { display: flex; align-items: center; justify-content: center; gap: 9px; color: var(--muted); }.one-night-wait > span { width: 8px; aspect-ratio:1; border-radius:50%; background:var(--one-night-accent); box-shadow:0 0 14px color-mix(in srgb,var(--one-night-accent) 58%,transparent); }.one-night-progress { margin:0; color:var(--muted); text-align:center; }
.one-night-role-deck { padding:13px; display:flex; align-items:center; justify-content:center; flex-wrap:wrap; gap:7px; }.one-night-role-deck strong { margin-right:4px; font-size:12px; }.one-night-role-deck span { border:1px solid color-mix(in srgb,var(--one-night-accent) 20%,var(--line)); border-radius:999px; padding:5px 8px; color:var(--one-night-accent); background:color-mix(in srgb,var(--one-night-accent) 8%,var(--surface-inset)); font-size:10px; font-weight:800; }
.night-phase { min-height: 430px; }.night-action-card { padding: clamp(16px,4vw,24px); display:grid; gap:16px; }.one-night-targets,.one-night-centers { display:grid; grid-template-columns:repeat(auto-fit,minmax(120px,1fr)); gap:9px; }.one-night-targets button,.one-night-centers button { min-height:76px; display:grid; place-items:center; gap:5px; border:1px solid var(--line); border-radius:13px; color:var(--text); background:var(--surface-inset); cursor:pointer; }.one-night-targets b { width:28px; aspect-ratio:1; display:grid; place-items:center; border-radius:50%; color:var(--one-night-accent); background:color-mix(in srgb,var(--one-night-accent) 12%,var(--surface-inset)); }.one-night-targets button.selected,.one-night-centers button.selected { border-color:var(--one-night-accent); background:color-mix(in srgb,var(--one-night-accent) 11%,var(--surface-inset)); box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--one-night-accent) 18%,transparent); }.night-actions { display:flex; justify-content:flex-end; gap:9px; }.moon-waiting { min-height:230px; padding:30px; flex-direction:column; text-align:center; }.moon-waiting svg { color:var(--one-night-accent); }.moon-waiting strong { font-family:"Songti SC",serif; font-size:24px; }.moon-waiting span { max-width:380px; color:var(--muted); line-height:1.55; }
.discussion-status { display:flex; align-items:center; justify-content:center; gap:12px; padding:16px; color:var(--one-night-accent); }.discussion-status span { display:grid; gap:3px; }.discussion-status small { color:var(--muted); line-height:1.5; }.discussion-status strong { font-size:16px; }.one-night-results { display:grid; gap:6px; max-width:320px; }.one-night-results span { border:1px solid color-mix(in srgb,var(--one-night-accent) 20%,var(--line)); border-radius:10px; padding:8px; background:color-mix(in srgb,var(--one-night-accent) 7%,var(--surface-inset)); font-size:11px; line-height:1.5; }
