...
<style scoped>
.one-night-rules { display:grid; gap:18px; text-align:left; }.one-night-rules section { display:grid; gap:10px; }.one-night-rules h3 { margin:0; font-size:16px; }.one-night-rules ol,.one-night-rules ul { margin:0; padding-left:20px; color:var(--text-soft); line-height:1.65; }.one-night-rules li + li { margin-top:5px; }.one-night-rule-summary > p { margin:0; border:1px solid rgba(157,175,234,.22); border-radius:10px; padding:11px 12px; color:#c8d1ff; background:rgba(119,139,215,.08); line-height:1.55; }
.one-night-wake-order > div { display:flex; align-items:center; flex-wrap:wrap; gap:6px; }.one-night-wake-order span { border:1px solid var(--line); border-radius:999px; padding:5px 8px; color:#b9c7ff; background:var(--surface-inset); font-size:11px; font-weight:800; }.one-night-wake-order b { color:var(--muted); }.one-night-wake-order small { color:var(--muted); }
.one-night-role-guide > header { display:flex; align-items:baseline; justify-content:space-between; gap:10px; }.one-night-role-guide > header small { color:var(--muted); }.one-night-role-guide > div { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:9px; }.one-night-role-guide article { display:grid; gap:7px; border:1px solid var(--line); border-left:3px solid #75cda7; border-radius:10px; padding:11px 12px; background:var(--surface-inset); }.one-night-role-guide article.alignment-werewolf { border-left-color:#db737e; }.one-night-role-guide article.alignment-tanner { border-left-color:#d2a969; }.one-night-role-guide article.active { box-shadow:inset 0 0 0 1px rgba(157,175,234,.15); }.one-night-role-guide article > header { display:flex; align-items:center; gap:7px; }.one-night-role-guide article strong { font-size:14px; }.one-night-role-guide article span,.one-night-role-guide article em { color:var(--muted); font-size:9px; font-style:normal; }.one-night-role-guide article em { margin-left:auto; border-radius:999px; padding:3px 6px; color:#b9c7ff; background:rgba(119,139,215,.13); }.one-night-role-guide article p { margin:0; color:var(--text-soft); font-size:11px; line-height:1.55; }
