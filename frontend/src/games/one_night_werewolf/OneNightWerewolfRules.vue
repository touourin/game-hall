...
.one-night-role-guide > header { display:flex; align-items:baseline; justify-content:space-between; gap:10px; }.one-night-role-guide > header small { color:var(--muted); }.one-night-role-guide > div { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:9px; }.one-night-role-guide article { display:grid; gap:7px; border:1px solid var(--line); border-left:3px solid var(--green); border-radius:10px; padding:11px 12px; background:var(--surface-inset); }.one-night-role-guide article.alignment-werewolf { border-left-color:var(--red); }.one-night-role-guide article.alignment-tanner { border-left-color:var(--accent); }.one-night-role-guide article.active { box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--one-night-accent) 18%,transparent); }.one-night-role-guide article > header { display:flex; align-items:center; gap:7px; }.one-night-role-guide article strong { font-size:14px; }.one-night-role-guide article span,.one-night-role-guide article em { color:var(--muted); font-size:9px; font-style:normal; }.one-night-role-guide article em { margin-left:auto; border-radius:999px; padding:3px 6px; color:var(--one-night-accent); background:color-mix(in srgb,var(--one-night-accent) 11%,var(--surface-inset)); }.one-night-role-guide article p { margin:0; color:var(--text-soft); font-size:11px; line-height:1.55; }
