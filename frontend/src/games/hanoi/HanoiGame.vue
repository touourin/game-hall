...
.hanoi-metrics span, .hanoi-metrics small { display: block; }.hanoi-metrics span { color: var(--accent); font-size: clamp(16px, 3vw, 20px); font-weight: 900; }.hanoi-metrics small { margin-top: 3px; color: var(--muted); font-size: 10px; }
.hanoi-board { position: relative; min-height: clamp(330px, 52vw, 455px); padding: 24px clamp(8px, 2.5vw, 25px) 18px; overflow: hidden; }
.hanoi-board-glow { position: absolute; inset: 0; pointer-events: none; background: radial-gradient(circle at 50% 104%, color-mix(in srgb, var(--accent) 16%, transparent), transparent 48%), linear-gradient(180deg, transparent 55%, color-mix(in srgb, var(--bg) 40%, transparent)); }
.hanoi-board.finished { border-color: color-mix(in srgb, var(--accent) 58%, var(--line)); box-shadow: inset 0 0 50px color-mix(in srgb, var(--accent) 7%, transparent); }
.hanoi-board.finished .hanoi-board-glow { background: radial-gradient(circle at 82% 58%, color-mix(in srgb, var(--accent) 20%, transparent), transparent 26%), radial-gradient(circle at 50% 104%, color-mix(in srgb, var(--accent) 18%, transparent), transparent 48%), linear-gradient(180deg, transparent 55%, color-mix(in srgb, var(--bg) 40%, transparent)); animation: finish-glow 2.2s ease-in-out infinite alternate; }
...
.hanoi-tower:hover { background: color-mix(in srgb, var(--panel-highlight) 14%, transparent); }.hanoi-tower.selected { border-color: color-mix(in srgb, var(--accent) 64%, transparent); background: color-mix(in srgb, var(--accent) 7%, transparent); transform: translateY(-2px); }.hanoi-tower.target:not(.selected) { border-color: color-mix(in srgb, var(--green) 32%, transparent); background: color-mix(in srgb, var(--green) 4%, transparent); }.hanoi-tower.complete { background: linear-gradient(180deg, transparent, color-mix(in srgb, var(--accent) 9%, transparent)); }
.hanoi-tower.selected .hanoi-disc.movable { filter: brightness(1.13); box-shadow: inset 0 2px 0 color-mix(in srgb, white 44%, transparent), inset 0 -4px 8px color-mix(in srgb, black 18%, transparent), 0 0 0 3px color-mix(in srgb, var(--accent) 22%, transparent), 0 7px 18px color-mix(in srgb, var(--panel-shadow) 65%, transparent); transform: translateY(-4px); }
.hanoi-tower.complete .tower-name { color: var(--accent); }
...
.hanoi-guide > span { width: 40px; aspect-ratio: 1; display: grid; place-items: center; border-radius: 12px; color: var(--accent); background: color-mix(in srgb, var(--accent) 11%, transparent); }.hanoi-guide p { min-width: 0; margin: 0; }.hanoi-guide strong, .hanoi-guide small { display: block; }.hanoi-guide strong { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.hanoi-guide small { margin-top: 3px; color: var(--muted); }.hanoi-guide button { display: inline-flex; align-items: center; gap: 6px; border: 1px solid var(--line); border-radius: 10px; padding: 9px 11px; color: var(--muted); background: var(--surface-inset); font-weight: 800; }
.hanoi-result { padding: 24px; display: grid; justify-items: center; gap: 8px; text-align: center; }.hanoi-result > span { display: flex; align-items: center; gap: 7px; color: var(--green); font-weight: 850; }.hanoi-result h2 { margin: 3px 0 0; font-family: "Songti SC", "STSong", serif; font-size: clamp(32px, 7vw, 48px); }.hanoi-result > p { margin: 0; color: var(--muted); }.hanoi-result > div { width: min(100%, 520px); margin: 8px 0; display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 8px; }.hanoi-result > div span { border: 1px solid var(--line); border-radius: 11px; padding: 11px 7px; color: var(--muted); font-size: 10px; }.hanoi-result > div b { display: block; margin-bottom: 3px; color: var(--accent); font-size: 16px; }.hanoi-result .hanoi-result-tip { display: flex; align-items: center; gap: 6px; color: var(--accent); }.hanoi-result .ui-button--primary { margin-top: 8px; }
