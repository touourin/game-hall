...
.hanoi-board-glow { position: absolute; inset: 0; pointer-events: none; background: radial-gradient(circle at 50% 104%, color-mix(in srgb, var(--gold) 16%, transparent), transparent 48%), linear-gradient(180deg, transparent 55%, color-mix(in srgb, var(--bg) 40%, transparent)); }
...
.hanoi-tower:hover { background: color-mix(in srgb, var(--panel-highlight) 14%, transparent); }.hanoi-tower.selected { border-color: color-mix(in srgb, var(--gold) 64%, transparent); background: color-mix(in srgb, var(--gold) 7%, transparent); transform: translateY(-2px); }.hanoi-tower.target:not(.selected) { border-color: color-mix(in srgb, var(--green) 32%, transparent); background: color-mix(in srgb, var(--green) 4%, transparent); }.hanoi-tower.complete { background: linear-gradient(180deg, transparent, color-mix(in srgb, var(--gold) 9%, transparent)); }
.hanoi-tower.selected .hanoi-disc.movable { filter: brightness(1.13); box-shadow: inset 0 2px 0 color-mix(in srgb, white 44%, transparent), inset 0 -4px 8px color-mix(in srgb, black 18%, transparent), 0 0 0 3px color-mix(in srgb, var(--gold) 22%, transparent), 0 7px 18px color-mix(in srgb, var(--panel-shadow) 65%, transparent); transform: translateY(-4px); }
