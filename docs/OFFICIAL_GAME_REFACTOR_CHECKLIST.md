...
- [x] 全量验证通过：后端 564 项、第三方模块边界 48 项、前端 375 项；生产构建、主题选择器和月白云瓷对比度检查通过。
...
- [x] 全量验证通过：后端 565 项、第三方模块边界 48 项、前端 376 项；生产构建、主题选择器和月白云瓷对比度检查通过。
...
- [x] 新增原语契约测试，并同步返回按钮测试使用稳定的新选择器；前端 379 项、后端 565 项、第三方模块边界 48 项测试全部通过。
...
- [x] 保留动态生成的排行榜名次选择器、第三方插件 SDK 公共入口和引擎回放测试接缝；这些不是可删除的死代码。
- [x] 第三方游戏目录不在本批改动范围内；其插件自有类型告警不混入官方模块清理。
- [x] 运行时/源码新增 3 行、删除 54 行，净减少 51 行；测试删除 4 行；本批代码差异合计新增 3 行、删除 58 行，净减少 55 行。
- [x] 前端 379 项、后端 565 项、第三方模块边界 48 项测试全部通过；生产构建、主题选择器和月白云瓷对比度检查通过。
...
- [x] 前端 378 项、后端 565 项、第三方模块边界 48 项测试全部通过；生产构建、主题选择器和月白云瓷对比度检查通过。
